 ...
 * @param {string} textColor - Cor do texto (NÃO SERÁ USADA, mas mantida nas props).
 */
const CountdownTimer = ({ targetDate, textColor }) => { // A prop textColor é ignorada para o texto.
    ...
    if (timeLeft) {
        Object.keys(timeLeft).forEach(interval => {
            ...
            timerComponents.push(
                ...
                >
                    {/* 🚨 CORREÇÃO: COR FORÇADA PARA PRETO (#000) */}
                    <Text style={{ 
    ...
    if (!timeLeft) {
        // 🚨 CORREÇÃO: COR FORÇADA PARA PRETO (#000)
        return <Text style={{ color: '#000', fontSize: 24, fontWeight: 600 }}>PROMOÇÃO TERMINADA!</Text>;
    }
