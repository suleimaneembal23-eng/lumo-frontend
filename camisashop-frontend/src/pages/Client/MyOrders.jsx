...
import { EyeOutlined, ShoppingOutlined, ClockCircleOutlined, CheckCircleOutlined, CarOutlined, HomeOutlined, StopOutlined } from "@ant-design/icons";
  ...
  useEffect(() => {
    const fetchOrders = async () => {
      try {
        ...
        // Ajuste a URL se necessário. O endpoint correto geralmente é /api/orders/myorders ou similar, 
        // mas baseando-se no código anterior era /api/orders/user
  ...
  const columns = [
    {
      ...
      dataIndex: "_id",
      key: "_id",
      render: (text) => <Text strong>#{text.slice(-6).toUpperCase()}</Text>,
    },
    {
      title: "Data",
      dataIndex: "createdAt",
